<?php
	...
	$message .= '1) Créer un <a href="http://quebio.ca/entreprisebio/#tab3">compte </a><br><br>';
	$message .= '2) Utilisez ce lien pour nous faire <a href="http://quebio.ca/entreprisebio?reportid=' . $reportId . '"> parvenir votre opinion</a> <br><br>';
	...
	$message .= "<tr><td><strong>Enregistrement d'un nouveau compte:</strong> </td><td>" . "<a href='http://quebio.ca/entreprisebio/#tab3'>Appuyer Ici</a>" . "</td></tr>";$message .= "<tr><td><strong>Additional Information:</strong> </td><td>" . $additionalInformation . "</td></tr>";
	$message .= "</table>";
	$message .= "</body></html>";
	// Send E-mail.
