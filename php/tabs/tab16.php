...
<button type="button" id="BTN_RESTART">Enregistrer et entrer un autre exemple</button>
<button type="button" id="BTN_RE_LEAVE">Enregistrer et quitter l'évaluation</button>
